...
class Event: NSObject, NSCoding {
    ...
    required init(coder aDecoder: NSCoder) {
        ...
        self.eventPhotoData = aDecoder.decodeObjectForKey("EventPhotoData") as? UIImage
        super.init()
    }
    ...
    func encodeWithCoder(aCoder: NSCoder) {
        ...
        aCoder.encodeObject(eventPhotoData, forKey: "EventPhotoData")
    }
